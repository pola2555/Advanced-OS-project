...
class Second_chance_class:
    ...
    def run(self, pages:list = None, num_of_frames:int = None):
        ...
        this is just an example on the structure of the memory list not the actual output.
        '''
        ########################################################
        ########################################
        ######################
...
if __name__ == "__main__":
    ...
    num_of_frames = 3
    second_chance = Second_chance_class()
    memory = second_chance.run(pages=pages, num_of_frames=num_of_frames)
    for frame in memory:
        print(frame)